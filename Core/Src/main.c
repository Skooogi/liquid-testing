...
void PeriphCommonClock_Config(void);								// CubeMX did not generate this :(
...
int main(void)
{
  ...
  PeriphCommonClock_Config();						// CubeMX did not generate this :(
