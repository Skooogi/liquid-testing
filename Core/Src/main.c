...
static void MX_FDCAN1_Init(void)
{
  ...
  /*CAN_FilterTypeDef sf;								// TODO: Choose right filter type
  sf.FilterMaskIdHigh = 0x0000;						// TODO: Set filter if required
  sf.FilterMaskIdLow = 0x0000;						// TODO: Set filter if required
