##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.16.0] date: [Thu Jun 02 21:14:18 EEST 2022]
##########################################################################################################################
...
#######################################
clean:
	@rm -f $(BUILD_DIR)/*.o *~ > /dev/null
	@rm -f $(BUILD_DIR)/*.d *~ > /dev/null
	@rm -f $(BUILD_DIR)/*.lst *~ > /dev/null
	$(info Cleaned excess files!)
